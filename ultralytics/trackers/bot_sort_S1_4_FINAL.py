...
class BOTSORT(BYTETracker):
    ...
    def __init__(self, args, frame_rate=15):
        ...
        self.MAX_FISH = 9
        self.stable_frames = getattr(args, "stable_frames", 6)   ##可调参
        self.min_votes = getattr(args, "min_votes", 3)           ##可调参
    ...
    def _update_permanent_tracks(self):
        ...
        for track in self.tracked_stracks:
            ...
            too_old = (
                ...
                (self.frame_id - existing.end_frame)
                > getattr(self, "max_time_lost_perm", getattr(self, "max_time_lost", 0))
