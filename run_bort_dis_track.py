...
def main():
    ...
    parser.add_argument("--out_dir", default="/home/waas/yolo11_track/track_video&txt/S1_newww", help="Root output directory")
    ...
    # ReID
    parser.add_argument("--with_reid", action="store_true", help="Enable ReID")
